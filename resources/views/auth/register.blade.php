...
<body class="bg-gray-200 flex items-center justify-center min-h-screen">
    <div class="shadow-lg overflow-hidden bg-white flex" style="width: 850px; height: 550px;">
        <!-- Blue Section -->
        ...
        <!-- Form Section -->
        <div class="flex-auto p-6 background-pattern">
            <div class="max-w-md w-full mt-12">
                <h2 class="text-2xl font-inter font-extrabold text-gray-900 mb-6">Let's get you started</h2>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex items-center justify-between mt-4 space-x-3">
                        ...
                        <a href="{{ route('companyregister') }}" class="w-full py-1.5 px-3 bg-indigo-600 text-white font-bold text-center rounded-md text-sm hover:bg-indigo-700">
                            Join As Company!
                        </a>
                    </div>
                </form>
